...
class ConsumptionOptimizationsForecastDto {
  ...
  List<ChangeAttribute> generalPowerMeterHistoricalData;

  @JsonKey(name:"pv_production_meter_data")
  List<ChangeAttribute> pvProductionPowerMeterHistoricalData;
  ...
  factory ConsumptionOptimizationsForecastDto.fromJson(Map<String, dynamic> json) =>
      _$ConsumptionOptimizationsForecastDtoFromJson(json);

  Map<String, dynamic> toJson() => _$ConsumptionOptimizationsForecastDtoToJson(this);
}
